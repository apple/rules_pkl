...
load("@rules_bazel_integration_test//bazel_integration_test/private:integration_test_utils.bzl", "integration_test_utils")
...
""",
        ...
        "_test_runner_script": attr.label(
            default = "//tests/integration_tests:debug_test_runner.sh",
            executable = True,
            allow_files = True,
            cfg = "target",
        ),
